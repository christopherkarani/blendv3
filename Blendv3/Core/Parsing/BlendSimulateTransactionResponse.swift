...
@Observable public final class BlendSimulateTransactionResponse: Sendable {
    ...
    public let results: [BlendSimulateTransactionResult]?
    ...
    public init(
        ...
        results: [BlendSimulateTransactionResult]? = nil,
        error: String? = nil
    ) {
