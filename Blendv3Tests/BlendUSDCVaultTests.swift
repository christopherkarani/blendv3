...
class BlendUSDCVaultTests: XCTestCase {
    ...
    func testPoolStatsCalculations() {
        ...
        XCTAssertEqual(stats.utilizationRate, 0.4) // 40%
        XCTAssertEqual(stats.availableLiquidity, 600_000)
    }
    ...
    func testPoolStatsWithZeroSupply() {
        ...
        XCTAssertEqual(stats.utilizationRate, 0)
        XCTAssertEqual(stats.availableLiquidity, 0)
    }
    ...
    func testRefreshPoolStats() async throws {
        ...
        XCTAssertEqual(vault.poolStats?.totalSupplied, 1_000_000)
        XCTAssertEqual(vault.poolStats?.currentAPY, 5.5)
    }
